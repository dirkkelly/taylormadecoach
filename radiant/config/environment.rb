...
Radiant::Initializer.run do |config|
  ...
  config.extensions = [:archive, :textile_filter, :layouts, :settings, :redirect, :navigation, :import_export, :drag, :paperclipped]
  ...
  config.action_controller.session = {
    :key => '_www.taylormadecoach.com.au_session',
    :secret      => '37729204d322be27f965c796f9e324c05e81370b'
  }
